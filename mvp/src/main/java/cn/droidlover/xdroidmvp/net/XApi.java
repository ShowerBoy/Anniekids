...
import cn.droidlover.xdroidmvp.utils.MyGsonConverterFactory;
import cn.droidlover.xdroidmvp.utils.SSLSocketClient;
import cn.droidlover.xdroidmvp.utils.TokenInterceptor;
...
//                .addConverterFactory(GsonConverterFactory.create());
    ...
    public OkHttpClient getClient(String baseUrl, NetProvider provider) {
        ...
        builder.addInterceptor(new TokenInterceptor(deviceID, appVersion));
